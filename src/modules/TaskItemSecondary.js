  ...
  render() {
    return (
      ...
      >
        ...
        } style={{ flex: 2}} size={30} icon={faArrowRight} />
        ...
        <Text style= {{fontSize: 21, flex: 2, borderWidth: 2, borderBottomColor: this.props.stt.isActive ? this.props.configuration.theme.l1  : this.props.configuration.theme.l2,
        borderRadius: 11 , textAlign:'center', marginRight: 5}}>
